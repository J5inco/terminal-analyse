...
CALCUL JUSTE PRIX: 1) base DCF/multiples 2) ajustements qualitatifs en % 3) final=base+ajust 4) sécurité=final×0.75
...
{"reco":"ACHETER|ACCUMULER|NEUTRE|ALLÉGER|VENDRE","profile":"${profileLabel}","target":"X ${currSym}","upside":"+X%","nextEvent":{"label":"","date":""},"kpis":[{"label":"","val":"","sub":"","color":"teal"}],"ca":{"labels":[],"data":[],"unit":"Md${currSym}"},"earnings":{"labels":[],"net":[],"netUnit":"M${currSym}","margin":[]},"segments":{"labels":[],"pct":[],"ca":[],"caRaw":[],"unit":"M${currSym}"},"peers":{"labels":[],"pe":[]},"peersEv":{"labels":[],"data":[]},"perHistory":{"labels":[],"data":[],"avg":0},"fcfYieldHistory":{"labels":[],"data":[]},"valScore":5,"valLights":[{"label":"","val":"","signal":"green|amber|red"}],"valPosition":[{"label":"","pct":0,"vs":"cheaper|expensive"}],"justePrice":{"base":0,"baseLabel":"","adjustments":[{"label":"","impact":0,"positive":true}],"final":0,"safetyMargin":0,"safetyMarginPct":25,"currentPrice":${priceNum||0},"vsCurrentPct":0,"dcf":{"labels":["2025e","2026e","2027e","2028e","2029e","Val.term."],"data":[],"unit":"M${currSym}"},"qualitativeImpact":""},"expectedReturn":0,"expectedReturnDetail":"","bnaHistory":{"labels":[],"data":[]},"divHistory":{"labels":[],"data":[]},"debtHistory":{"labels":[],"data":[]},"ratios":[{"l":"","v":"","c":"green"}],"qualitative":{"positives":[],"negatives":[],"governance":"","esg":"","moat":""},"news":[{"title":"","summary":"","impact":"positive|neutral|negative","date":""}],"calendar":[{"label":"","date":"","type":"results|dividend|ag"}],"catalysts":[{"icon":"🎯","title":"","text":""}],"risks":[{"warn":false,"title":"","text":""}],"verdict":""}`;
